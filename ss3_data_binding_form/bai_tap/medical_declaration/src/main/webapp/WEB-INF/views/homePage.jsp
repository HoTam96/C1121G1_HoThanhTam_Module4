...
<form:form modelAttribute="medical" action="update" method="post">
    ...
    <form:radiobuttons path="travelInformation" items="${stringlist}" class="form-check-input" id="exampleRadios1"/>
...
<%--    &lt;%&ndash;                <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios3" value="option3" disabled>&ndash;%&gt;--%>
